...
= Why is some stuff not working? =

This is version < 1, stuff won't be working 100% until we reach version 1. Also, until BuddyPress is officially released, Events will not go into version 1.
